...
class StartTrackingFragment: Fragment() {
    ...
    override fun onCreateView(
        ...
        startTrackingViewModel =
            ViewModelProvider(this).get(StartTrackingViewModel::class.java) // Define the ViewModel
        ...
        startTrackingViewModel.renderEditTextErrors.observe(viewLifecycleOwner,
            { error ->
                ...
                when (error) {
                    ...
                    TextInputLayoutErrors.NO_BOOK_FOUND -> binding.bookTitleLayout.error =
                        getString(R.string.no_book_found)

                    TextInputLayoutErrors.BOOK_TITLE_MISSING -> binding.bookTitleLayout.error =
                        getString(R.string.book_title_missing)

                    TextInputLayoutErrors.START_PAGE_COUNT_MISSING -> binding.startingPageCountLayout.error =
                        getString(R.string.starting_page_count_missing)

                    TextInputLayoutErrors.FINISH_PAGE_COUNT_MISSING -> binding.finishingPageCountLayout.error =
                        getString(R.string.finishing_page_count_missing)
    ...
    private val startDatePickerListener =
        DatePickerDialog.OnDateSetListener { _, year, month, day ->
            ...
            startTrackingViewModel.startDateInMilliseconds =
    ...
    private val finishDatePickerListener =
        DatePickerDialog.OnDateSetListener { _, year, month, day ->
            ...
            startTrackingViewModel.finishDateInMilliseconds =
                calendar.timeInMillis // Pass the date in milliseconds to the ViewModel

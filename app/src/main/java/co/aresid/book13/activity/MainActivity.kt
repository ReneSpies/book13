...
class MainActivity: AppCompatActivity() {
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		binding = ActivityMainBinding.inflate(LayoutInflater.from(this)) // Define the binding and inflate the layout
	...
	private fun createSpeedDialClickListener() {
		...
		val navigationHostFragment = supportFragmentManager.findFragmentById(R.id.navigation_host) as NavHostFragment // Find the NavigationHostFragment
		val navigationController = navigationHostFragment.navController // Collect the NavController from the NavigationHostFragment
		...
		binding.speedDialView.setOnActionSelectedListener { actionItem ->
			...
			).setEnterAnim(R.anim.fade_in).setPopEnterAnim(R.anim.fade_in).setExitAnim(R.anim.fade_out).setPopExitAnim(R.anim.fade_out).build()
